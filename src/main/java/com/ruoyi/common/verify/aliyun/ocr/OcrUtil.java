package com.ruoyi.common.verify.aliyun.ocr;
...
public class OcrUtil {
    ...
    public JSONObject idCardORC(String idCard) throws ExecutionException, InterruptedException {
        ...
        AsyncClient client = AsyncClient.builder()
                .region(aliyunConfig.getOssparams().getRegionId())
                .credentialsProvider(provider)
                .overrideConfiguration(ClientOverrideConfiguration.create().setEndpointOverride(aliyunConfig.getOssparams().getEndpoint()))
                .build();
