package com.ruoyi.project.business.util.wechat.service;

import cn.binarywang.wx.miniapp.api.WxMaService;
import cn.binarywang.wx.miniapp.api.impl.WxMaServiceImpl;
import cn.binarywang.wx.miniapp.bean.WxMaJscode2SessionResult;
import cn.binarywang.wx.miniapp.config.impl.WxMaDefaultConfigImpl;
import com.ruoyi.project.business.pay.wechat.config.WxPayConfig;
...
public class WxMiniAppService {
    ...
    private WxMaService getWxMaService() {
        if (wxMaService == null) {
            ...
            config.setSecret(wxPayConfig.getPayparams().getAppSecret());
